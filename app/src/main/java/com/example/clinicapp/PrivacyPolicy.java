...
public class PrivacyPolicy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_privacy_policy);  // Set the layout
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Privacy Policy");  // Set the title
        }

        // Set up the WebView to display the privacy policy content
    ...
    // Method to return the full Privacy Policy HTML as a String
    private String getPrivacyPolicyHtml() {
        return
                "<h1>Privacy Policy</h1>" +
                        ...
                        "<li><p><strong>Application</strong> refers to LU Clinic Care, the software program provided by the Company.</p></li>" +
                        "<li><p><strong>Company</strong> (referred to as either 'the Company', 'We', 'Us' or 'Our' in this Agreement) refers to LU Clinic Care.</p></li>" +
                        ...
                        "<ul>" +
                        "<li>By email: csa22024@gmail.com</li>" +
                        "</ul>";
